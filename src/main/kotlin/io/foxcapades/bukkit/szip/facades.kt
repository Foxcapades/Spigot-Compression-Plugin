...
internal lateinit var Plugin: StackZip

internal inline val Server: Server
  get() = Plugin.server

internal inline val ProtocolManager
  get() = Plugin.protocolManager
...
internal object Logger {
  ...
  inline fun trace(arg: Any?) {
    if (Config.Logging.enableTrace)
      Plugin.logger.info { "[TRACE] $arg" }
  }
  ...
  inline fun trace(log: String, arg1: Any?, arg2: Any?, arg3: Any?) {
    if (Config.Logging.enableTrace)
      Plugin.logger.info { "[TRACE] ${log.format(arg1, arg2, arg3)}" }
  }
}
