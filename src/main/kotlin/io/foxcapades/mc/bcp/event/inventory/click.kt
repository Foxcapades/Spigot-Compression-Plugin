...
private fun BCInvClickEvent.handleStandardLeftClick() {
  Logger.trace("[handleStandardLeftClick] for player %s on %s slot", player, slotType)
  cursor.ifNotEmpty(::handleStandardItemPlace)
}

private fun BCInvClickEvent.handleStandardRightClick() {
  Logger.trace("[handleStandardRightClick] for player %s on %s slot", player, slotType)
  cursor.ifNotEmpty(::handleStandardItemPlace)
}
...
private fun BCInvClickEvent.handleStandardItemPlace() {
  Logger.trace("[handleStandardItemPlace] for player %s on %s slot", player, slotType)
...
private fun BCInvClickEvent.handleStandardShiftLeftClick() {
  Logger.trace("[handleStandardShiftLeftClick] for player %s on %s slot", player, slotType)
  when {
